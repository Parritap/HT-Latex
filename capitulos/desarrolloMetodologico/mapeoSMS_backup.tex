\ChapterImageStar[cap:revisionLiteratura]{Revisión sis\begin{table\ChapterImageStar[cap\ChapterImageStar[cap:revisionLiteratura]{Revisión sistemática de la literatura}{./images/fondo.png}\label{cap:revisionLiteratura}
...
\subsubsection{Definición de preguntas de investigación}eratura]{Revisión sistemática de la literatura}{./images/fondo.png}\label{cap:revisionLiteratura}
...
\subsubsection{Definición de metas para el \SMS}[H]
		\centering
		\renewcommand{\arraystretch}{1.2} % Menor espaciado entre filas
		\footnotesize % Texto más pequeño
		\begin{tabular}{|c|p{12cm}|} % Columna de descripción más ancha
			\hline
			\textbf{Métrica} & \textbf{Descripción}                                                                                 \\ \hline
			M1               & Cantidad de trabajos relacionados con los Universos de HTCondor vinculados con los dominios de:
			\begin{itemize}[nosep,leftmargin=*]
				\item Computación distribuida y paralela.
				\item HTC
				\item Desarrollo de software.
				\item Tecnologías de virtualización y microservicios.
				\item Redes de computadores.
				\item Infraestructura computacional.
				\item Inteligencia artificial.
				\item Análisis de datos.
				\item Pensamiento computacional.
				\item Entre otros.
			\end{itemize}
			Y que además sean usados como herramienta para fortalecer funciones esenciales universitarias como:
			\begin{itemize}[nosep,leftmargin=*]
				\item Investigación
				\item Docencia
				\item Extensión
...
\ChapterImageStar[cap:revisionLiteratura]{Revisión sistemática de la literatura}{./images/fondo.png}\label{cap:revisionLiteratura}\mbox{}\\
\section{Construcción de la bitácora}
